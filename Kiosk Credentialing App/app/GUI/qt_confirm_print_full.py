...
class QtConfirmPrintFull(QtWidgets.QFrame):
    def __init__(self, parent, config, participant, lang, printed_symbol, callback):
        super(QtConfirmPrintFull, self).__init__(parent)
        ...
        self.Body.setGeometry(QtCore.QRect(20, 210, 900, 500))
        font_size = "48pt"
        ...
        self.Printer_Image.setGeometry(QtCore.QRect(980, 100, 300, 600))
